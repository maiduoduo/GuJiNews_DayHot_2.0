...
import com.cnews.guji.smart.util.TimeSPUtil;
import com.cnews.guji.smart.util.ToastUitl;
import com.cnews.guji.smart.util.VerticalImageSpan;
...
import static com.cnews.guji.smart.util.DateTimeUtils.FORMATT_YD;
 ...
 */
public class HomeHottopMultipleRecycleAdapter extends BaseMultiItemQuickAdapter<HomeTopIFengBean.ItemBean, BaseViewHolder> implements OnBannerListener {
     ...
     */
    public HomeHottopMultipleRecycleAdapter(Context context, List<HomeTopIFengBean.ItemBean> data, String code) {
        super(data);
...
//        holder.setText(R.id.tv_title, data.title == null ? "" : data.type + "__" + data.style.view + "  " + data.style.slideCount + "图\n" + data.title);
        ...
        holder.setText(R.id.tvCommentnum, String.format(context.getString(R.string.news_commentsize), data.commentsall == null ? "" : data.commentsall));
