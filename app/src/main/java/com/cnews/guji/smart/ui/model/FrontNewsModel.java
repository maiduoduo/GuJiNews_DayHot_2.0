 ...
 * 要闻数据
 */
public class FrontNewsModel<S> implements ImpNewsContract.model {
    @Override
...
//        http://c.m.163.com/nc/article/headline/T1348647909107/0-20.html
        return  RetrofitClient.getInstance(context).getApi(HostType.NORMAL_TEST_TYPE).getClothes(AppConstant.GOODS_TYPE_CODE, AppConstant.GOODS_TYPE_NAME);
    }
