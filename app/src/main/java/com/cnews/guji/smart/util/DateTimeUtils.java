...
public class DateTimeUtils {
    ...
    public static final String FORMATT_MDHM = "MM月dd日 HH:mm";
    public static final String FORMATT_YD = "MM-dd";
    ...
    public static final SimpleDateFormat ydformat = new SimpleDateFormat("MM-dd");
...
//        }
        ...
        /**
         * 将字符串日期转换成java.util.Date类型 时间格式：自定义
         *
         * @param time
         * @return
         * @throws ParseException
         */
        public static String parseTimeFormat(String timeFormat,String time) throws ParseException {
            SimpleDateFormat ydformat = new SimpleDateFormat(timeFormat);
            return parseDateToStr(ydformat.parse(time),timeFormat);
        }
    ...
    public static String stampToTime(long stamp) {
         ...
         * 将字符串转为时间戳
         */
        public static long getStringToTamp(String time,String format) {
...
//        }
    ...
    /**
     * 获取短时间格式
     * @param strdate     必须是标准的日期格式
     *                 yyyy-MM-dd HH:mm:ss  或者 yyyy/MM/dd HH:mm:ss
     * @return
     */
    public static String getShortTime(String strdate) {
        long millis = 0;
        if (strdate != null && !"null".equals(strdate) && !TextUtils.isEmpty(strdate)){
            String upy = "";
            if (strdate.contains("/")){
                String[] split = strdate.split("\\/");
                upy = split[0]+"-"+split[1]+"-"+split[2];
                ILog.e("SquareMoreHotActivity","split:"+new Gson().toJson(split));
                ILog.e("SquareMoreHotActivity","upy:"+upy);
                if (!TextUtils.isEmpty(upy)){
                    Date date3 = null;
                    try {
                        date3 = datetimeFormat.parse(upy);
                    } catch (ParseException e) {
                    }
                    if (date3 != null){
                        millis = date3.getTime();
                    }
                }
            }else if (strdate.contains("-")){
                Date date4 = null;
                try {
                    date4 = datetimeFormat.parse(strdate);
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                if (date4 != null){
                    millis = date4.getTime();
                }
            }
        }
        ...
        ILog.e("SquareMoreHotActivity","millis:"+millis);
        ILog.e("SquareMoreHotActivity","curDate.getTime():"+curDate.getTime());
        ILog.e("SquareMoreHotActivity","date.getTime():"+date.getTime());
        ILog.e("SquareMoreHotActivity","durTime:"+durTime);
