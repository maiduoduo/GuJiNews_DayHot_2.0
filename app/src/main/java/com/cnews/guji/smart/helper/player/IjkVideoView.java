package com.cnews.guji.smart.helper.player;
...
import com.cnews.guji.smart.helper.player.controller.BaseVideoController;
import com.cnews.guji.smart.helper.player.util.NetworkUtil;
import com.cnews.guji.smart.helper.player.util.PlayerConstants;
import com.cnews.guji.smart.helper.player.util.WindowUtil;
import com.cnews.guji.smart.helper.player.widget.ResizeSurfaceView;
import com.cnews.guji.smart.helper.player.widget.ResizeTextureView;
import com.cnews.guji.smart.helper.player.widget.StatusView;
...
public class IjkVideoView extends BaseIjkVideoView {
    ...
    protected boolean checkNetwork() {
        if (NetworkUtil.getNetworkType(getContext()) == NetworkUtil.NETWORK_MOBILE && !PlayerConstants.IS_PLAY_ON_MOBILE_NETWORK) {
            ...
            statusView.setButtonTextAndAction(getResources().getString(R.string.continue_play), new View.OnClickListener() {
                @Override
