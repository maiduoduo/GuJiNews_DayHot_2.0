...
import com.cnews.guji.smart.helper.headerview.utils.PtrCLog;

/**
 * This layout_comment_list_title view for "Pull to Refresh(Ptr)" support all of the view, you can contain everything you want.
...
public class PtrFrameLayout extends ViewGroup {
    ...
    protected void onFinishInflate() {
        ...
        if (childCount > 2) {
            ...
            errorView.setText("The content view in PtrFrameLayout is empty. Do you forget to specify its id in xml layout_comment_list_title file?");
            mContent = errorView;
            addView(mContent);
        }
    ...
    private void layoutChildren() {
        ...
        if (mHeaderView != null) {
            ...
            // enhance readability(header is layout_comment_list_title above screen when first init)
    ...
    private void performRefreshComplete() {
        ...
        if (mScrollChecker.mIsRunning && isAutoRefresh()) {
            // do nothing
            if (DEBUG) {
                PtrCLog.d(LOG_TAG, "performRefreshComplete do nothing, scrolling: %s, auto refresh_q: %s",
