...
public class ExpandTextView extends LinearLayout {
    ...
    private void initWithAttrs(Context context, AttributeSet attrs) {
        ...
        int textColor = a.getColor(R.styleable.ExpandTextView_et_textColor,
                defaultTextColor);  //取颜色值，默认defaultTextColor
        textSize = a.getDimensionPixelSize(R.styleable.ExpandTextView_et_textSize, defaultTextSize);//取颜字体大小，默认defaultTextSize
        maxLine = a.getInt(R.styleable.ExpandTextView_et_maxLine, defaultLine);//取颜显示行数，默认defaultLine
        text = a.getString(R.styleable.ExpandTextView_et_text);//取文本内容
