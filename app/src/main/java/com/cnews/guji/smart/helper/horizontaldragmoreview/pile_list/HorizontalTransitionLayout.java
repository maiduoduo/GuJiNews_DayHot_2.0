package com.cnews.guji.smart.helper.horizontaldragmoreview.pile_list;
...
public class HorizontalTransitionLayout extends BaseTransitionLayout {
    ...
    public HorizontalTransitionLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textSize = a.getFloat(R.styleable.scene_textSize1, textSize);
        textColor = a.getColor(R.styleable.scene_textColor1, textColor);
