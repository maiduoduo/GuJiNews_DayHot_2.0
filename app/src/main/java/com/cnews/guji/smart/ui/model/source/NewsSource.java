...
public class NewsSource<S> {
    ...
    public static final String NAME_TYPE_FASTMESSAGESCROLL = "fastmessagescroll";
    //广场
    public static final String NAME_TYPE_HOTSPOT = "hotspot";
    public static final String NAME_TYPE_SOLECOLUMN = "solecolumn";
    ...
    public static final String NAME_VIEW_FASTMESSAGESCROLL = "fastmessagescroll";
    //广场
    public static final String NAME_VIEW_TITLEIMGBACK2 = "titleimgback2";
    public static final String NAME_VIEW_HOTSPOT2  = "hotspot2";
    public static final String NAME_VIEW_SOLECOLUMN = "solecolumn";


    //广场数据类型
    //1.导航菜单
    public static final String NAME_TYPE_SQUARE_NAVIGATION = "square_navigation";
    //2.热议
    public static final String NAME_TYPE_SQUARE_HOTWORD= "hotword";
    //3.列表
    public static final String NAME_TYPE_SQUARE_LIST = "list";
    ...
    public static boolean isFinanceHN(HashMap map) {
        return  map.containsValue(NAME_TYPE_FINANCEHN);
    }
    ...
    public static List getTabCurrentShowData(int tabType, Context context) {
        List<ChannelBean> myjson = getMultiIndexJsonData(context, NewsConstant.ASSET_HOME_NEWS_TABS_MY);
        List<ChannelBean> morejson = getMultiIndexJsonData(context, NewsConstant.ASSET_HOME_NEWS_TABS_MORE);
        List<ChannelBean> alljson = new ArrayList<>();
        if (myjson != null && morejson != null) {
            if (tabType == 0) {
                return myjson;
            } else if (tabType == 1) {
                return morejson;
            } else if (tabType == 2) {
                myjson.addAll(morejson);
                alljson.addAll(myjson);
                return alljson;
            } else {
                String[] tabtitles = new String[]{"TAB", "TAB"};
     ...
     * 解析json
     */
    public static List<ChannelBean> getMultiIndexJsonData(Context context, final String fileName) {
     ...
     * @return
     */
    public static boolean isExitSquareNavigation(HashMap map) {
        return map.containsValue(NAME_TYPE_SQUARE_NAVIGATION);
    }
     ...
     * @return
     */
    public static boolean isExitSquareHotword(HashMap map) {
        return map.containsValue(NAME_TYPE_SQUARE_HOTWORD);
    }
     ...
     * @return
     */
    public static boolean isExitSquareList(SquareMainBean bean) {
        return bean.getType().equals(NAME_TYPE_SQUARE_LIST);
    }
     ...
     * @return
     */
    public static boolean isExitSquareMapList(HashMap map) {
        return map.containsValue(NAME_TYPE_SQUARE_LIST);
    }
}
