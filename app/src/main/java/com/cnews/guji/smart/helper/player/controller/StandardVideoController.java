package com.cnews.guji.smart.helper.player.controller;
...
import com.cnews.guji.smart.helper.player.IjkVideoView;
import com.cnews.guji.smart.helper.player.util.BatteryReceiver;
import com.cnews.guji.smart.helper.player.util.WindowUtil;
import com.cnews.guji.smart.helper.player.widget.MarqueeTextView;
    ...
    public void setPlayState(int playState) {
        ...
        switch (playState) {
            ...
            case IjkVideoView.STATE_BUFFERED:
                ...
                ijkTitle.setVisibility(GONE);
                ijkControlSize.setVisibility(GONE);
                ILog.e("STATE_BUFFERED");
                break;
            case IjkVideoView.STATE_PLAYBACK_COMPLETED:
                ILog.e("STATE_PLAYBACK_COMPLETED");
                hide();
                startPlayButton.setVisibility(GONE);
                ijkTitle.setVisibility(GONE);
                ijkControlSize.setVisibility(GONE);
