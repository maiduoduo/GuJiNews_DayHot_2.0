...
//                .addCallAdapterFactory(RxJavaCallAdapterFactory.create())
    ...
    public static OkHttpClient getOkHttpClient(){
        Api retrofitManager = sRetrofitManager.get(HostType.ITOUTIAO_NEWS_TYPE);
        if (retrofitManager == null) {
            retrofitManager = new Api(HostType.ITOUTIAO_NEWS_TYPE);
            sRetrofitManager.put(HostType.ITOUTIAO_NEWS_TYPE, retrofitManager);
        }
    ...
    public static String getCacheControl() {
        return NetWorkUtils.isNetworkAvailable(BaseApplication.getAppContext()) ? CACHE_CONTROL_AGE : CACHE_CONTROL_CACHE;
    }
