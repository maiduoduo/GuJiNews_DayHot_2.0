...
public class ProgressLayout extends LinearLayout {
    ...
    private void showLoadingView() {
        if (loadingView == null) {
            loadingView = (LinearLayout) layoutInflater.inflate(R.layout.guji_layout_loading_view, null);
    ...
    private void showErrorView() {
        if (errorView == null) {
            errorView = (LinearLayout) layoutInflater.inflate(R.layout.guji_layout_error_view, null);
