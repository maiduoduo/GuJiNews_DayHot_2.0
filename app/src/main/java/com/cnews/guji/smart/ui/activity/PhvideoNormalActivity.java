 ...
 * @author JSYL-DCL
 */
public class PhvideoNormalActivity extends BaseActivity {

    public static void launch(Activity context) {
        Intent intent = new Intent(context, PhvideoNormalActivity.class);
...
//        intent.putExtra(AID, bodyBean.getDocumentId());
    ...
    public int getLayoutId() {
        return R.layout.activity_phvideo_normal;
    }
