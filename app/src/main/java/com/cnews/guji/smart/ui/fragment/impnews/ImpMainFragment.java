 ...
 * @author JSYL-DCL
 */
public class ImpMainFragment extends BaseFragment {
    private final String TAG1 = ImpMainFragment.this.getClass().getSimpleName();
    ...
    public static ImpMainFragment getInstance(String title) {
        ImpMainFragment fragment = new ImpMainFragment();
        return fragment;
    }
...
//                startActivity(new Intent(getActivity(), MovieSearchActivity.class));
    ...
    private void setNewsList(List<CategoryModel> modelList, List<String> channelNames) {
        ...
        for (int i = 0; i < modelList.size(); i++) {
            if (i == 0) {
                ImpTopNewsFragment frontNewsMixMainFragment = new ImpTopNewsFragment();
                ...
                ImpMineNewsFragment mineCategoryFragment = new ImpMineNewsFragment();
                Bundle bundle = new Bundle();
                mineCategoryFragment.setArguments(bundle);
                mFragmentList.add(mineCategoryFragment);
                channelNames.add(modelList.get(i).title);
            }else {
                ImpMineNewsFragment movieCategoryFragment = new ImpMineNewsFragment();
                Bundle bundle = new Bundle();
     ...
     * @return
     */
    private ImpMineNewsFragment createListFragments(CategoryModel config) {
        ImpMineNewsFragment fragment = new ImpMineNewsFragment();
        Bundle bundle = new Bundle();
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        if (!hidden){//展示，可见  // 相当于Fragment的onResume()
            ILog.e(TAG2,"onHiddenChanged ImpMainFragment:"+hidden);
            ...
            //相当于Fragment的onPause()
            ILog.e(TAG2,"[else]onHiddenChanged ImpMainFragment:"+hidden);
        }
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser){//展示，可见   // 相当于onResume()方法--获取焦点
            ILog.e(TAG2,"isVisibleToUser ImpMainFragment:"+isVisibleToUser);
//            StatusBarCompatUtils.setDarkMode(getActivity());
        }else {
            // 相当于onpause()方法---失去焦点
            ILog.e(TAG2,"[else]isVisibleToUser ImpMainFragment:"+isVisibleToUser);
        }
    }
    ...
    public void onResume() {
        super.onResume();
        ILog.e(TAG1,"isVisibleToUser ImpMainFragment  onResume---------------");
    }
