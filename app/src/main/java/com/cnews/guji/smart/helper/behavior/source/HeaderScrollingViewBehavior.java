package com.cnews.guji.smart.helper.behavior.source;
...
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
            ...
            if (header != null) {
                if (ViewCompat.getFitsSystemWindows(header)
                    ...
                    if (ViewCompat.getFitsSystemWindows(child)) {
                        // If the set succeeded, trigger a new layout_comment_list_title and return true
                        child.requestLayout();
                        return true;
                    }
                }
    ...
    /**
     * The gap between the top of the scrolling view and the bottom of the header layout_comment_list_title in pixels.
     */
