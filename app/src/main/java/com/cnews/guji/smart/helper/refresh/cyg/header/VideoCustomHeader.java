 ...
 * Des:    TODO:
 */
public class VideoCustomHeader extends LinearLayout implements RefreshHeader {
    ...
    public VideoCustomHeader(@NonNull Context context) {
        this(context, null);
        initView();
    }

    public VideoCustomHeader(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
        initView();
    }

    public VideoCustomHeader(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
