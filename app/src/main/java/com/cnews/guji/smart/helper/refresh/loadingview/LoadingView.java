package com.cnews.guji.smart.helper.refresh.loadingview;
...
import com.cnews.guji.smart.helper.headerview.PtrFrameLayout;
import com.cnews.guji.smart.helper.headerview.PtrUIHandler;
...
public class LoadingView extends LinearLayout implements in.srain.cube.views.ptr.PtrUIHandler {
    ...
    public LoadingView(Context context) {
        this(context, null);
        mTranslationDistance = dip2px(40);
        initLayout();
    }
    ...
    @Override
    public void onUIReset(in.srain.cube.views.ptr.PtrFrameLayout frame) {

    }

    @Override
    public void onUIRefreshPrepare(in.srain.cube.views.ptr.PtrFrameLayout frame) {

    }

    @Override
    public void onUIRefreshBegin(in.srain.cube.views.ptr.PtrFrameLayout frame) {
    }

    @Override
    public void onUIRefreshComplete(in.srain.cube.views.ptr.PtrFrameLayout frame) {
