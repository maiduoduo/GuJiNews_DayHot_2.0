...
public class ClassifySearchBean {
    ...
    public static class ListBean implements MultiItemEntity {
        ...
        public int getItemType() {
            switch (getShowst()){
                case 1:
                    return ApiConstant.TYPE_CLASSIFY_WISH;
                case 2:
                    return ApiConstant.TYPE_CLASSIFY_NORMAL;
                case 3:
                    return ApiConstant.TYPE_CLASSIFY_BUY;
                case 4:
                    return ApiConstant.TYPE_CLASSIFY_PRESALE;
                default:
                    return ApiConstant.TYPE_CLASSIFY_NORMAL;
            }
        }
