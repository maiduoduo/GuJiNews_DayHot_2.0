package com.jack.mc.cyg.cygptr.recyclerview;
...
public class RecyclerBaseQuickAdapterWithHF extends RecyclerView.Adapter<ViewHolder> {
    ...
    private class MyOnClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (RecyclerBaseQuickAdapterWithHF.this.onItemClickListener != null) {
                RecyclerBaseQuickAdapterWithHF.this.onItemClickListener.onItemClick(RecyclerBaseQuickAdapterWithHF.this, vh, position);
            }
    ...
    private class MyOnLongClickListener implements OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            int position = getRealPosition(vh.getLayoutPosition());
            if (RecyclerBaseQuickAdapterWithHF.this.onItemLongClickListener != null) {
                RecyclerBaseQuickAdapterWithHF.this.onItemLongClickListener.onItemLongClick(RecyclerBaseQuickAdapterWithHF.this, vh,
						position);
            }
    ...
    public static interface OnItemClickListener {
        void onItemClick(RecyclerBaseQuickAdapterWithHF adapter, ViewHolder vh, int position);
    }

    public static interface OnItemLongClickListener {
        void onItemLongClick(RecyclerBaseQuickAdapterWithHF adapter, ViewHolder vh, int position);
    }

    private RecyclerView.Adapter<ViewHolder> mAdapter;

    public <T extends RecyclerView.Adapter> RecyclerBaseQuickAdapterWithHF(T adapter) {
        super();
